...
public:
	...
	// Remarks:
	//-----------------------------------------------------------------------
	CXTPChartAxis(CXTPChartDiagram2D* pDiagram);
...
public:
	...
	void SetGridSpacing(double bGridSpacing);
...
//{{AFX_CODEJOCK_PRIVATE
	...
	LPDISPATCH OleGetConstantLines();
	LPDISPATCH OleGetCustomLabels();
	LPDISPATCH OleGetStrips();
	LPDISPATCH OleGetLabel();
	LPDISPATCH OleGetTickMarks();
	LPDISPATCH OleGetTitle();
	LPDISPATCH OleGetGridLines();
	LPDISPATCH OleGetRange();
	LPDISPATCH OleGetInterlacedFillStyle();

	OLE_COLOR OleGetColor();
	void OleSetColor(OLE_COLOR clr);
	OLE_COLOR OleGetInterlacedColor();
	void OleSetInterlacedColor(OLE_COLOR clr);
	OLE_COLOR OleGetInterlacedColor2();
	void OleSetInterlacedColor2(OLE_COLOR clr);
...
protected:
	CXTPChartDiagram2D* m_pDiagram;                  //The pointer to chart digram 2d object.
	...
	friend class CXTPChartAxisView;
...
AFX_INLINE CXTPChartDiagram2D* CXTPChartAxis::GetDiagram() const {
	return m_pDiagram;
}
