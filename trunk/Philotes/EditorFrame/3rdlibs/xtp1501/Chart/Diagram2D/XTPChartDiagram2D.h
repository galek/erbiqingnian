...
public:
	...
	//     with.
	// Returns:
	//     A pointer to CXTPChartDiagramPane object.
	//-------------------------------------------------------------------------
	CXTPChartDiagramPane* GetPane() const;

	void SetPane(CXTPChartDiagramPane* pPane);
...
protected:
	...
	CXTPChartDiagramPane* m_pPane;       //The pointer to diagram pane object.
...
AFX_INLINE CXTPChartDiagramPane* CXTPChartDiagram2D::GetPane() const {
	return m_pPane;
}
