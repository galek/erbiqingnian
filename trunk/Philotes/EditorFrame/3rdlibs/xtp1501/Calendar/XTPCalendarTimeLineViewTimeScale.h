...
public:
	...
	//-----------------------------------------------------------------------
	virtual BOOL HitTestEx(CPoint pt, XTP_CALENDAR_HITTESTINFO* pHitTest);

	CXTPEmptyRect m_rcScale; // internal member to keep time scale rectangle
...
protected:
	...
	CXTPEmptyRect m_rcRect;  // internal member used for layout adjustment
