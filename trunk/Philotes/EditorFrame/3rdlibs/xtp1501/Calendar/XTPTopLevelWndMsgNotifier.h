...
//===========================================================================
// Summary:
//     Define windows message which send by CXTPTopLevelWndMsgNotifier when
//     current timezone is changed.
//===========================================================================
const UINT XTP_WM_TIME_ZONE_CHANGED = RegisterWindowMessage(XTP_WM_TIME_ZONE_CHANGED_MSG);
