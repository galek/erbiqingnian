...
class Renderer
{
	...
	public:
		...
		void render(const Matrix4 &eye, const RendererProjection &proj, RendererTarget *target=0, bool depthOnly=false);
...
public:
	...
	private:
		...
		virtual void bindViewProj(const Matrix4 &eye, const RendererProjection &proj)    = 0;
