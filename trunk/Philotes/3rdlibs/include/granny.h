...
#define GRANNY_64BIT_PTR 0
  ...
  #endif
  #define GRANNY_64BIT_TYPE __int64
#elif _MACOSX || defined(__MWERKS__) || defined(linux) || defined(__linux__)
  #define GRANNY_DYNIMP(ret) ret
  #define GRANNY_DYNEXP(ret) ret
  #define GRANNY_CALLBACK(ret) ret
  #define GRANNY_DYNIMPDATA(type) type
...
#define GrannyCurrentGRNStandardTag (0x80000000 + 27)
...
typedef struct granny_head_bezier granny_head_bezier;
...
typedef enum granny_log_message_origin
{
    ...
    GrannyTrackGroupMessage,
    GrannyThreadSafetyMessage,
...
#define GrannyProductCopyright "1999-2006 by RAD Game Tools, Inc., All Rights Reserved."
...
GrannyTypeSizeCheck(sizeof(granny_head_bezier) == (sizeof(granny_real32) + 
                                                   sizeof(granny_real32) + 
                                                   sizeof(granny_real32) + 
                                                   sizeof(granny_real32) + 
                                                   sizeof(granny_real32) + 
...
GRANNY_DYNLINK(bool) GrannyDataTypesAreEqualWithNames(granny_data_type_definition * A,
                                                      granny_data_type_definition * B);
GRANNY_DYNLINK(bool) GrannyDataTypesAreEqualWithNameCallback(granny_data_type_definition * A,
                                                             granny_data_type_definition * B,
...
GRANNY_DYNLINK(granny_int32x) GrannyGetResultingCurveSize(granny_curve_builder * Builder);
...
GRANNY_DYNLINK(granny_int32x) GrannyGetResultingCurveDataSize(granny_curve_builder * Builder);
...
GRANNY_DYNLINK(void) GrannyCalculateLODErrorValuesAllBindings(granny_model_instance * ModelInstance,
                                                              ...
                                                              bool AnimationHasScales,
                                                              granny_real32 ManualScaler);
GRANNY_DYNLINK(granny_real32) GrannyGetLODErrorValue(granny_animation_binding * AnimationBinding,
...
GRANNY_DYNLINK(granny_animation_lod_builder *) GrannyCalculateAnimationLODBegin(granny_animation * Animation,
                                                                                granny_real32 ManualScaler);
...
GRANNY_DYNLINK(bool) GrannyComputeBasisConversion(granny_file_info * FileInfo,
...
GRANNY_DYNLINK(granny_curve2 * ) GrannyFitBSplineToSamples(granny_bspline_solver * Solver,
                                                           ...
                                                           granny_int32x SampleCount,
                                                           granny_real32 dT,
                                                           granny_data_type_definition * CurveDataType,
...
GRANNY_DYNLINK(granny_real32) GrannyFindAllowedLODError(granny_real32 ErrorInPixels,
                                                        granny_int32x ViewportWidthInPixels,
                                                        granny_real32 CameraFOV,
...
GRANNY_DYNLINK(bool) GrannyIsBlendDagLeafType(granny_blend_dag_node * Node);
GRANNY_DYNLINK(granny_blend_dag_node_type) GrannyGetBlendDagNodeType(granny_blend_dag_node * Node);
...
GRANNY_DYNLINK(granny_int32x) GrannyGetBlendDagNodeChildrenCount(granny_blend_dag_node * Node);
...
GRANNY_DYNLINK(void) GrannySetBlendDagNodeResultWeight(granny_blend_dag_node * Node,
                                                       granny_real32 Weight);
GRANNY_DYNLINK(granny_real32) GrannyGetBlendDagNodeResultWeight(granny_blend_dag_node * Node);
GRANNY_DYNLINK(void) GrannyGetBlendDagTreeMotionVectors(granny_blend_dag_node * Node,
                                                        granny_real32 SecondsElapsed,
                                                        granny_real32 * ResultTranslation,
                                                        granny_real32 * ResultRotation,
                                                        bool Inverse);
GRANNY_DYNLINK(void) GrannyUpdateBlendDagTreeMatrix(granny_blend_dag_node * Node,
                                                    granny_real32 SecondsElapsed,
                                                    granny_real32 const * ModelMatrix4x4,
                                                    granny_real32 * DestMatrix4x4,
                                                    bool Inverse);
...
GRANNY_DYNLINK(granny_local_pose *) GrannySampleBlendDagTreeLODSparseReentrant(granny_blend_dag_node * RootNode,
                                                                               granny_int32x BoneCount,
                                                                               granny_real32 AllowedError,
                                                                               granny_int32x const * SparseBoneArray,
                                                                               granny_dag_pose_cache * PoseCache);
GRANNY_DYNLINK(granny_local_pose *) GrannySampleBlendDagTreeLODSparse(granny_blend_dag_node * RootNode,
                                                                      granny_int32x BoneCount,
                                                                      granny_real32 AllowedError,
                                                                      granny_int32x const * SparseBoneArray);
GRANNY_DYNLINK(granny_local_pose *) GrannySampleBlendDagTree(granny_blend_dag_node * RootNode,
                                                             granny_int32x BoneCount);
GRANNY_DYNLINK(granny_local_pose *) GrannySampleBlendDagTreeLOD(granny_blend_dag_node * RootNode,
                                                                granny_int32x BoneCount,
                                                                granny_real32 AllowedError);
GRANNY_DYNLINK(granny_local_pose *) GrannySampleBlendDagTreeReentrant(granny_blend_dag_node * RootNode,
                                                                      granny_int32x BoneCount,
                                                                      granny_dag_pose_cache * PoseCache);
GRANNY_DYNLINK(granny_local_pose *) GrannySampleBlendDagTreeLODReentrant(granny_blend_dag_node * RootNode,
                                                                         granny_int32x BoneCount,
                                                                         granny_real32 AllowedError,
                                                                         granny_dag_pose_cache * PoseCache);
...
GRANNY_DYNLINK(granny_blend_dag_node *) GrannyDuplicateBlendDagTree(granny_blend_dag_node * SourceTreeRoot,
                                                                    granny_blend_dag_node ** SourceNodeList,
                                                                    granny_blend_dag_node ** DestNodeList,
                                                                    granny_int32 SizeOfNodeList,
                                                                    bool AutoFreeCreatedModelInstances);
GRANNY_DYNLINK(bool) GrannyIsBlendDagNodeValid(granny_blend_dag_node * Node,
                                               char ** ReasonFailed,
                                               granny_blend_dag_node ** NodeFailed);
GRANNY_DYNLINK(bool) GrannyIsBlendDagTreeValid(granny_blend_dag_node * RootNode,
                                               char ** ReasonFailed,
                                               granny_blend_dag_node ** NodeFailed);
GRANNY_DYNLINK(granny_int32x) GrannyFindBlendDagTreeDepth(granny_blend_dag_node * RootNode);
...
GRANNY_DYNLINK(bool) GrannyRebasePointers(granny_data_type_definition * Type,
                                          ...
                                          bool RebaseStrings);
GRANNY_DYNLINK(bool) GrannyRebasePointersStringCallback(granny_data_type_definition * Type,
                                                        void * Data,
                                                        granny_intaddrx Offset,
...
GRANNY_DYNLINK(granny_file *) GrannyReadPartialFileFromReader(granny_file_reader * Reader,
                                                              granny_grn_file_magic_value * FileMagicValue);
...
GRANNY_DYNLINK(void) GrannyReadFileSection(granny_file_reader * Reader,
                                           granny_file * File,
                                           granny_int32x SectionIndex);
GRANNY_DYNLINK(void) GrannyReadFileSectionInPlace(granny_file_reader * Reader,
                                                  granny_file * File,
                                                  granny_int32x SectionIndex,
                                                  void * Memory);
...
GRANNY_DYNLINK(void) GrannyFixupFileSectionPhase2(granny_file_reader * Reader,
                                                  granny_file * File,
                                                  granny_int32x SectionIndex,
                                                  granny_grn_pointer_fixup const*  PointerFixupArray);
GRANNY_DYNLINK(void) GrannyFreeFile(granny_file * File);
GRANNY_DYNLINK(granny_int32x) GrannyGetFileSectionOfLoadedObject(granny_file * File,
                                                                 void * Object);
...
GRANNY_DYNLINK(granny_head_bezier *) GrannyGetGrannyHeadBezier(granny_int32x BezierIndex);
...
GRANNY_DYNLINK(void) GrannyModulationCompositeLocalPoseSparse(granny_local_pose * BasePose,
                                                              ...
                                                              granny_int32x const * SparseBoneArray);
GRANNY_DYNLINK(void) GrannyLocalPoseFromWorldPose(granny_skeleton *  Skeleton,
                                                  granny_local_pose * Result,
                                                  granny_world_pose const * WorldPose,
                                                  granny_real32 const * Offset4x4,
                                                  granny_int32x const  FirstBone,
                                                  granny_int32x const  BoneCount);
GRANNY_DYNLINK(void) GrannyLocalPoseFromWorldPoseNoScale(granny_skeleton *  Skeleton,
                                                         granny_local_pose * Result,
                                                         granny_world_pose const * WorldPose,
                                                         granny_real32 const * Offset4x4,
                                                         granny_int32x const  FirstBone,
...
GRANNY_DYNLINK(void) GrannyOodle1Decompress(bool FileIsByteReversed,
                                            granny_int32x CompressedBytesSize,
                                            void * CompressedBytes,
...
GRANNY_DYNLINK(granny_int32x) GrannyBuildTangentSpace(granny_int32x TriangleCount,
                                                      ...
                                                      granny_int32 * VertexToVertexMap,
                                                      granny_int32 * VertexToTriangleMap,
                                                      granny_real32 TangentMergingMinCosine);
...
GRANNY_DYNLINK(void) GrannyBuildWorldPoseNoCompositeSparse(granny_skeleton const * Skeleton,
                                                           ...
                                                           granny_real32 const * Offset4x4,
                                                           granny_world_pose * Result);
GRANNY_DYNLINK(void) GrannyBuildCompositeFromWorldPose(granny_skeleton const * Skeleton,
                                                       granny_int32x FirstBone,
                                                       granny_int32x BoneCount,
                                                       granny_world_pose * Result);
#ifdef __cplusplus
