...
#define MSS_VERSION      "7.0x"     // Version string needs to be 4 characters long for benefit of MIDIECHW and SETSOUND 
#define MSS_MAJOR_VERSION 7
#define MSS_MINOR_VERSION 0
#define MSS_SUB_VERSION   24
#define MSS_VERSION_DATE "01-Jun-07"
