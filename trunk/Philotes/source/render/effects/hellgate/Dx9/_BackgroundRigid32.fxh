...
#define TECHNIQUE32(points,shadowtype,spotlight,indoor,diffuse2,normalmap,lightmap,selfillum,dir0,dir1,sh9,sh4,hemilight,speculardir,specularmap,specularlut,specularpts,psworldnmap,cubemap,scroll) \
    DECLARE_TECH TBackground_32_##points##_##shadowtype##_##spotlight##indoor##diffuse2##normalmap##lightmap##selfillum##dir0##dir1##sh9##sh4##hemilight##speculardir##specularmap##specularlut##specularpts##psworldnmap##cubemap##scroll < \
	BG_SV \
	...
	int ScrollUV			= scroll;						\
	> { pass Main	{ \
		COMPILE_SET_VERTEX_SHADER( BG_VS, VS20_BACKGROUND_32BYTES( points,  \
																	_ON_VS, \
																	spotlight, \
																	indoor, \
																	diffuse2, \
																	...
																	MANUAL_FOG, \
																	shadowtype ) ); \
		COMPILE_SET_PIXEL_SHADER( BG_PS, PS20_BACKGROUND(	_ON_PS, \
															spotlight, \
															indoor, \
															normalmap, \
															dir0, \
