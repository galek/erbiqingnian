...
{
    ph_assert(srcNumBytes >= 2);
    ph_assert(0 != srcPtr);
    ph_assert(0 != dstPtr);
    ph_assert((srcNumBytes > 0) && (dstNumBytes >= RunLengthCodec::GetSafeRLEBufferSize(srcNumBytes)));
