...
public:
	...
	CXTPMarkupPathGeometry* CreateGeometry() const;
...
public:
	...
	CXTPMarkupPathGeometry(const MARKUP_POINTF* pPoints, const BYTE* pTypes, int nCount);
...
public:
	...
	CXTPMarkupPathGeometry* Stretch(CSize sz) const;
...
public:
	CXTPMarkupPathGeometry* GetGeometry() const;
...
public:
	static CXTPMarkupDependencyProperty* m_pDataProperty;
};
...
AFX_INLINE MARKUP_POINTF* CXTPMarkupPathGeometry::GetPoints() const {
	return m_pPoints;
}
AFX_INLINE int CXTPMarkupPathGeometry::GetCoint() const {
	return m_nCount;
}
AFX_INLINE BYTE* CXTPMarkupPathGeometry::GetTypes() const {
	return m_pTypes;
}
AFX_INLINE CRect CXTPMarkupPathGeometry::GetBounds() const {
	return m_rcBounds;
}
