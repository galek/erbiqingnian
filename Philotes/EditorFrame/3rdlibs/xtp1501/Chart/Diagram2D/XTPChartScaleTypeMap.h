...
public:
	...
	//     This is a pure virtual function.
	//-------------------------------------------------------------------------
	virtual CXTPChartString InternalToValue(const CXTPChartString& strFormat, double dValue) const = 0;
...
public:
	...
	// Remarks:
	//-------------------------------------------------------------------------
	virtual CXTPChartString InternalToValue(const CXTPChartString& strFormat, double dValue) const;
