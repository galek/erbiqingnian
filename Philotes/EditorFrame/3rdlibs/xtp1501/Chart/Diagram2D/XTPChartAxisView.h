...
public:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Call this function to create a CXTPChartAxisViewTickEnumerator object,
	//     this object helps to enumerate the tick marks on an axis.
	// Parameters:
	//     bMinor     - TRUE to enumerate the minor tick marks and FALSE to enumerate
	//                  the major tick marks.
	// Returns:
	//     Returns a pointer to CXTPChartAxisViewTickEnumerator object.
	// Remarks:
	// See Also:
	//-------------------------------------------------------------------------
	CXTPChartAxisViewTickEnumerator* CreateTickMarksEnumerator(BOOL bMinor);
	...
	// Parameters:
	//     pDC       - The chart device context object.
	//     rcDiagram - The bounding rectangle.
	// Remarks:
	// See Also:
	//-------------------------------------------------------------------------
...
AFX_INLINE int CXTPChartAxisView::GetSize() const {
	return m_nSize;
}
AFX_INLINE double CXTPChartAxisView::GetGridSpacing() const {
	return m_dGridSpacing;
}
AFX_INLINE CRect CXTPChartAxisView::GetBounds() const {
	return m_rcBounds;
}
