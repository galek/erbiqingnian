...
public:
	...
	CXTPChartString GetFormat() const;
	void SetFormat(const CXTPChartString& strFormat);
...
//{{AFX_CODEJOCK_PRIVATE
	...
	afx_msg void OleSetFormat(LPCTSTR lpszFotmat);
...
AFX_INLINE CXTPChartString CXTPChartAxisLabel::GetFormat() const {
	return m_strFormat;
}
AFX_INLINE void CXTPChartAxisLabel::SetFormat(const CXTPChartString& strFormat) {
