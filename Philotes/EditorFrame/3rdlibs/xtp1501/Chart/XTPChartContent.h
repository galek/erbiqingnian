...
public:
	...
	//     rcBounds - The rectangle of the device context.
	// Returns:
	//     A pointer to CXTPChartDeviceContext object.If the chart has 3D diagram,
	//     it returns CXTPChartOpenGLDeviceContext object.
	// Remarks:
	//-----------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this function to check whether there is any 3D diagram in the
	//     content.
	// Parameters:
	//     pSeries - A pointer to chart series object.
	// Remarks:
	//-----------------------------------------------------------------------
	BOOL Has3DDiagram() const;
